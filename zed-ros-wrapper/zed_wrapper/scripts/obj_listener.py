...
# below 4 regarding as dictionary and saved as .npy
 ...
 # writing to an addtional txt for direct checking
	dict_everything4frame = {} 
    	...
    	dict_2D_vis[str(int(str(time))/1000)] = array_2D_vis
   	...
   	dict_3D_full[str(int(str(time))/1000)] = array_3D_full
    	dict_vislabel[str(int(str(time))/1000)] = list_vis_label
   	dict_fullinfo[str(int(str(time))/1000)] = list_full_info
...
if __name__ == '__main__':
    ...
    f.truncate(0) 
    f2 = open("/media/tud-jxavier/SSD/data/zed/object_detection_data/2D_BB_and_info.txt",'a')
    f2.truncate(0)
    dict_2D_vis = {}
    dict_3D_vis = {}
    dict_3D_full = {}
  ...
  #  with open("/media/tud-jxavier/SSD/data/zed/object_detection_data/2D_vis_dict_array.pkl","wb") as tf:
#	pickle.dump(dict_2D_vis,tf)
 #   with open("/media/tud-jxavier/SSD/data/zed/object_detection_data/3D_vis_dict_array.pkl","wb") as tf:
#	pickle.dump(dict_3D_vis,tf)
 #   with open("/media/tud-jxavier/SSD/data/zed/object_detection_data/3D_full_array.pkl","wb") as tf:
#	pickle.dump(dict_3D_full,tf)
 #   with open("/media/tud-jxavier/SSD/data/zed/object_detection_data/dict_vislabel_list.pkl","wb") as :
#	pickle.dump(dict_vislabel,tf)
#    with open("/media/tud-jxavier/SSD/data/zed/object_detection_data/dict_fullinfo_list.pkl","wb") as tf:
#	pickle.dump(dict_fullinfo,tf)


    path_2dz =  "/media/tud-jxavier/SSD/data/zed/object_detection_data/2D_vis_dict_array.npz"
    path_3dz =  "/media/tud-jxavier/SSD/data/zed/object_detection_data/3D_vis_dict_array.npz"
    path_3d_fullz =  "/media/tud-jxavier/SSD/data/zed/object_detection_data/3D_full_array.npz"
    path_vislabelz =  "/media/tud-jxavier/SSD/data/zed/object_detection_data/dict_vislabel_list.npz"
    path_fullinfoz =  "/media/tud-jxavier/SSD/data/zed/object_detection_data/dict_fullinfo_list.npz"
 
    np.savez(path_2dz,**dict_2D_vis)
    ...
    np.savez(path_3d_fullz,**dict_3D_full)
    np.savez(path_vislabelz, **dict_vislabel)
    np.savez(path_fullinfoz,**dict_fullinfo)
