...
public:
    Mux() {
        ...
        // besides above mux_sub, the node can actually have much more subs, they are within the channels!
    ...
    void publish_to_drive(double desired_velocity, double desired_steer) {  //  this function if for key and joy to publish driving msg on /drive ; as for brake, nav, randomwalk, they use channels to publish driving msg on /drive;
