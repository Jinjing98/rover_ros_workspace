...
class MovementManager:
    def __init__(self, max_linear_speed = 0.5, max_angular_speed = 0.628):
        ...
        self.tpub = rospy.Publisher('/managed/joy', Twist, queue_size=2)
    ...
    def move_straight(self, distance=0):  #arrive  fastly by straight line given some distance s in front of you
        self.xtraveled_last_movement = 0
        self.ztraveled_last_movement = 0
        ...
        sendmsg.angular.z = 0
        sendmsg.linear.x = 0
        print "the car has go straight for" ,self.xtraveled_last_movement, "m"
        self.tpub.publish(sendmsg)

    def turn(self, distance=0):   #turn   some distance (radians)  you
        self.xtraveled_last_movement = 0
        self.ztraveled_last_movement = 0
        ...
        sendmsg.angular.z = 0
        sendmsg.linear.x = 0
	print "the car has turned for" ,self.ztraveled_last_movement, "radian"
        self.tpub.publish(sendmsg)
