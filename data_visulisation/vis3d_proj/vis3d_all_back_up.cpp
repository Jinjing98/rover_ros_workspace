...
std::string fname = "/media/tud-jxavier/SSD/data/zed/3D_vis_dict_array.npz";//  not need to input
...
std::string path4tsps = "/media/tud-jxavier/SSD/data/zed/timestamps/pcd_zed_OD.txt";
