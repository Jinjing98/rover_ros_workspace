...
class DCA1000:
    ...
    def read(self, timeout=1):
        ...
        while True:
            ...
            #print("Packets lost total:", self.total_packets_lost)
            self.prev_packet_num = packet_num # muss auch beim naechsten call da sein
            ...
            if not (self.total_packets - 1):
                ...
                #TODO: hier unbedingt noch beschreiben, wann der naechste frame aufhoert!!!! curr_frame_end_byte neu setzen
                print("#### frame captured ####")
                ...
                # kommt hier zum ueberschreiben, wenn frameende erreicht -->nein, da frameende im oberen Fall abgeckt, auch verlorene pakete stoeren nicht
                self.frame_buff[curr_frame_packet_idx : curr_frame_packet_idx + INT16_IN_PACKET] = data
